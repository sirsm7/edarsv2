...
// KEMASKINI V3.2: Penambahan Templat Analisa Trend Kohort
// ==========================================
...
export function getComparisonDetailHeader(names = {}) {
    ...
    // Auto-adjust colspan untuk menyokong E3 dan Beza ke-2 (Trajektori)
...
// [COMMENT SYNTAX] SURGICAL EDIT START: Templat Visual Analisa Trend Kohort
export function getTrendSchoolHeader(isE3, label1, label2, label3) {
    return `
    <thead>
        <tr>
...
export function getTrendSchoolRow(s, i, isE3) {
...
export function getTrendSubjectHeader(isE3, label1, label2, label3) {
    return `
    <thead>
        <tr>
            <th class="border px-2 py-2 w-10 bg-gray-50" rowspan="2">Bil</th>
...
export function getTrendSubjectRow(s, i, isE3, top5Improved, top5Declined) {
